...
*** Refactor to make it SPEAK DOMAIN LANGUAGE: ***

We have made names refactoring:
- no_ping            --> ping_lost_detector
- ping_is_on         --> ping_back_detector
- sudo_ensure_net_up --> ensure_interfaces_up  (who cares it must run via sudo; important is what is does, not how)
- sudo_ifconfig_down --> put_interfaces_down   (tell what not how)
- sudo_ifconfig_up   --> put_interfaces_up     (tell what not how)

See how much - right now - it speaks "domain language"; test readability?
"""
