...
# 'trac', 'native', 'fruity', 'bw', 'vim', 'vs', 'tango', 'rrt', 'xcode', 'igor', 'paraiso-light', 'paraiso-dark',
...
latex_documents = [
    (master_doc, 'Moler.tex', 'Moler Documentation',
     'Nokia', 'manual'),
]
...
man_pages = [
    (master_doc, 'moler', 'Moler Documentation',
     [author], 1)
]
