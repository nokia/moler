...
class CommandTextualGeneric(Command):
    ...
    def __init__(self, connection, prompt=None, newline_chars=None, runner=None):
        ...
        self.terminating_timeout = 3  # value for terminating command if it timeouts. Set positive value for command
        #                               if they can do anything if timeout. Set 0 for  command if it cannot do anything
        #                               if timeout.
