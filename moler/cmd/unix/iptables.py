...
class Iptables(GenericUnixCommand):
    ...
    def _parse_chain(self, line):
        if self._regex_helper.search_compiled(Iptables._re_parse_chain, line):
            ...
            self.current_ret[self.chain] = {}
            self.current_ret[self.chain]["POLICY"] = self._regex_helper.group("POLICY")
            self.current_ret[self.chain]["PACKETS"] = self._regex_helper.group(
                "PACKETS"
            )
    ...
    _re_parse_chain_references = re.compile(
        r"Chain\s+(?P<NAME>\S+)\s+\((?P<REFERENCES>\d+) references\)$"
    )

    def _parse_chain_references(self, line):
        if self._regex_helper.search_compiled(
            Iptables._re_parse_chain_references, line
        ):
            self.chain = self._regex_helper.group("NAME")
            self.current_ret[self.chain] = {}
            self.current_ret[self.chain]["REFERENCES"] = self._regex_helper.group(
                "REFERENCES"
            )
            self.current_ret[self.chain]["CHAIN"] = []
            self._key_details = []
    ...
    _re_parse_headers = re.compile(
        r"(?P<HEADERS>pkts\s+bytes\s+target\s+prot\s+opt\s+in\s+out\s+source\s+destination)"
    )
        ...
        if self.chain and self._key_details and self._regex_helper.search_compiled(Iptables._re_parse_details, line):
            ...
            if len(values) >= len(self._key_details):
                ...
                if self._regex_helper.search_compiled(re_for_rest, line):
                    ...
                    self.current_ret[self.chain]["CHAIN"].append(
                        ret
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "13",
                "PROT": "sctp",
                "REST": "limit: avg 2000/sec " "burst 80",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "limit: avg 2000/sec " "burst 80"},
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "0",
                "PROT": "icmp",
                "REST": "icmptype 8 ctstate " "NEW,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "0",
                "PROT": "icmp",
                "REST": "icmptype 8 limit: " "avg 25/sec burst 5",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "icmptype 8 limit: " "avg 25/sec burst " "5"},
            {
                ...
                "PKTS": "0",
                "PROT": "icmp",
                "REST": "icmptype 0 limit: " "avg 25/sec burst 5",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "icmptype 0 limit: " "avg 25/sec burst " "5"},
            {
                ...
                "PKTS": "6101",
                "PROT": "icmp",
                "REST": "icmptype 3 limit: " "avg 25/sec burst 5",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "icmptype 3 limit: " "avg 25/sec burst " "5"},
            {
                ...
                "PKTS": "0",
                "PROT": "icmp",
                "REST": "icmptype 11 limit: " "avg 25/sec burst 5",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "icmptype 11 limit: " "avg 25/sec burst " "5"},
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "0",
                "PROT": "udp",
                "REST": "multiport sports " "13080:13099,13120:13140",
                "SOURCE": "10.1.52.248",
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "0",
                "PROT": "all",
                "REST": "u32 " '"0x0&0xf000000=0x6000000:0xf000000"',
                "SOURCE": "0.0.0.0/0",
                "TARGET": "DROP",
            },
            {"REST": "u32 " '"0x0&0xf000000=0x6000000:0xf000000"'},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "multiport dports 15010:15014 state " "RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "multiport dports 15010:15014 state " "RELATED,ESTABLISHED"},
            ...
            },
            {
                ...
                "PKTS": "0",
                "PROT": "udp",
                "REST": "udp spt:67 dpt:68 ctstate " "RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "udp spt:67 dpt:68 ctstate " "RELATED,ESTABLISHED"},
            ...
            },
            {
                ...
                "PKTS": "0",
                "PROT": "udp",
                "REST": "udp dpts:5001:5010 ctstate " "RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "udp dpts:5001:5010 ctstate " "RELATED,ESTABLISHED"},
            ...
            {"REST": "udp spt:7 dpt:7"},
            {
                ...
                "PKTS": "0",
                "PROT": "udp",
                "REST": "udp dpts:33434:33933 ADDRTYPE match " "dst-type LOCAL",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "udp dpts:33434:33933 ADDRTYPE match " "dst-type LOCAL"},
            ...
            },
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "tcp spt:389 ctstate " "RELATED,ESTABLISHED",
                "SOURCE": "10.83.225.1",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "tcp spt:389 ctstate " "RELATED,ESTABLISHED"},
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "0",
                "PROT": "udp",
                "REST": "udp spt:53 ctstate " "RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "udp spt:53 ctstate " "RELATED,ESTABLISHED"},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "tcp spt:53 ctstate " "RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "tcp spt:53 ctstate " "RELATED,ESTABLISHED"},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "tcp spt:21 ctstate " "RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "tcp spt:21 ctstate " "RELATED,ESTABLISHED"},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "tcp spt:20 dpts:1024:65535 " "ctstate RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "tcp spt:20 dpts:1024:65535 " "ctstate RELATED,ESTABLISHED"},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "tcp spt:22 dpts:1024:65535 " "ctstate RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "tcp spt:22 dpts:1024:65535 " "ctstate RELATED,ESTABLISHED"},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "tcp spt:23 dpts:1024:65535 " "ctstate RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "tcp spt:23 dpts:1024:65535 " "ctstate RELATED,ESTABLISHED"},
            ...
            {"REST": "tcp dpt:6000"},
            {
                ...
                "PKTS": "0",
                "PROT": "tcp",
                "REST": "multiport sports 8002,8003 " "ctstate RELATED,ESTABLISHED",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "MP_TRAFFIC_RATE_LIMIT",
            },
            {"REST": "multiport sports 8002,8003 " "ctstate RELATED,ESTABLISHED"},
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "254",
                "PROT": "all",
                "REST": "limit: avg 2000/sec " "burst 32",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "limit: avg 2000/sec " "burst 32"},
        ...
        "CHAIN": [
            {
                ...
                "PKTS": "0",
                "PROT": "all",
                "REST": "limit: avg " "100/sec burst " "5",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "limit: avg " "100/sec burst " "5"},
...
COMMAND_KWARGS_frm2 = {"options": "-L INPUT -t mangle -n"}
    ...
    "INPUT": {
        "CHAIN": [
            ...
            },
            {
                ...
                "OPT": "--",
                "PROT": "tcp",
                "REST": "tcp dpt:8080 state NEW limit: up to " "100/min burst 10",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "tcp dpt:8080 state NEW limit: up to " "100/min burst 10"},
            ...
            {"REST": "tcp dpt:8080 state NEW"},
            {
                ...
                "OPT": "--",
                "PROT": "tcp",
                "REST": "tcp dpt:8443 state NEW limit: up to " "100/min burst 10",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "tcp dpt:8443 state NEW limit: up to " "100/min burst 10"},
            ...
            {"REST": "udp spt:123 dpt:123"},
            {
                ...
                "OPT": "--",
                "PROT": "udp",
                "REST": "udp dpts:33434:33933 limit: avg " "25/sec burst 10",
                "SOURCE": "0.0.0.0/0",
                "TARGET": "ACCEPT",
            },
            {"REST": "udp dpts:33434:33933 limit: avg " "25/sec burst 10"},
