...
class Iperf3(Iperf2):
    ...
    def _validate_options(self, options):
        client_only_options = [("-u", "--udp"), ("-t", "--time"), ("-P", "--parallel")]
    ...
    _r_rec_tcp_svr = rf"{_r_id}\s+{_r_interval}\s+{_r_transfer}\s+{_r_bitrate}"
    _r_rec_tcp_cli = rf"{_r_rec_tcp_svr}\s+{_r_retr}\s+{_r_cwnd}"
    _r_rec_udp_svr = rf"{_r_rec_tcp_svr}\s+{_r_jitter}\s+{_r_datagrams}"
    _r_rec_udp_cli = rf"{_r_rec_tcp_svr}\s+{_r_total_datagrams}"
    _r_rec_tcp_cli_summary = rf"{_r_rec_tcp_svr}\s+{_r_retr}"
    ...
    def _parse_connection_info(self, line):
        ...
        if (
            ...
            normalized_iperf_record = self._convert_jitter(normalized_iperf_record)
    ...
    def _convert_datagrams_parameter(iperf_record):
        if "Total_Datagrams" in iperf_record:
            iperf_record["Total_Datagrams"] = int(iperf_record["Total_Datagrams"])
        return iperf_record
    ...
    _r_rec_tcp_svr_report = rf"{_r_rec_tcp_svr}\s+{_r_option_report}"
    _r_rec_tcp_cli_report = rf"{_r_rec_tcp_cli}\s+{_r_option_report}"
    _r_rec_udp_svr_report = rf"{_r_rec_udp_svr}\s+{_r_option_report}"
    _r_rec_udp_cli_report = rf"{_r_rec_udp_cli}\s+{_r_option_report}"
    _r_rec_tcp_cli_summary_report = rf"{_r_rec_tcp_cli_summary}\s+{_r_option_report}"
    ...
    def _parse_connection_headers(self, line):
        if (
            not self._regex_helper.search_compiled(Iperf3._re_ornaments, line)
            and not self._regex_helper.search_compiled(
                Iperf3._re_summary_ornament, line
            )
            and not self._regex_helper.search_compiled(Iperf3._re_blank_line, line)
        ):
...
COMMAND_RESULT_basic_client = {
    "CONNECTIONS": {
        ...
        ("48058@127.0.0.1", "5201@127.0.0.1"): [
            {
                "Bitrate": 3400000000,
...
COMMAND_RESULT_basic_server = {
    "CONNECTIONS": {
        ...
        ("34761@127.0.0.1", "5201@127.0.0.1"): [
            {
                "Bitrate": 132500,
...
COMMAND_RESULT_tcp_ipv6_server = {
    "CONNECTIONS": {
        ...
        ("37988@127.0.0.1", "5901@127.0.0.1"): [
            {
                "Bitrate": 2425000000,
...
COMMAND_KWARGS_tcp_ipv6_client = {"options": "-c fd00::1:0 -V -p 5901 -i 1"}
    ...
    "CONNECTIONS": {
        ("127.0.0.1", "5017@127.0.0.1"): {
            "report": {
                ...
                "Jitter Raw": "0.000 ms",
                "Lost_Datagrams_ratio": "0%",
                "Lost_vs_Total_Datagrams": (0, 171),
                "Transfer": 3764387,
                "Transfer Raw": "3.59 MBytes",
            }
        },
        ("55371@127.0.0.1", "5017@127.0.0.1"): [
            {
                "Bitrate": 638375,
...
COMMAND_RESULT_udp_server_params = {
    "CONNECTIONS": {
        ...
        ("60306@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 3230830000,
...
COMMAND_RESULT_multiple_connections = {
    "CONNECTIONS": {
        ...
        ("46026@127.0.0.1", "5201@127.0.0.1"): [
            {
                "Bitrate": 1048750000,
        ...
        ("46036@127.0.0.1", "5201@127.0.0.1"): [
            {
                "Bitrate": 1048750000,
                "Bitrate Raw": "8.39 Gbits/sec",
                "Cwnd": 982016,
        ...
        ("46052@127.0.0.1", "5201@127.0.0.1"): [
            {
                "Bitrate": 1048750000,
                "Bitrate Raw": "8.39 Gbits/sec",
                "Cwnd": 982016,
        ...
        ("multiport@127.0.0.1", "5201@127.0.0.1"): [
            {
                "Bitrate": 3150000000,
...
COMMAND_KWARGS_multiple_connections_server = {"options": "-s -p 5016 -f k -i 1"}
...
COMMAND_RESULT_multiple_connections_server = {
    "CONNECTIONS": {
        ...
        ("38900@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 1526802750,
        ...
        ("38908@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 1526795500,
        ...
        ("38916@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 1526662625,
        ...
        ("multiport@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 4580277250,
...
COMMAND_KWARGS_multiple_connections_udp_server = {"options": "-s -p 5016 -f k -i 1"}
...
COMMAND_RESULT_multiple_connections_udp_server = {
    "CONNECTIONS": {
        ...
        ("33549@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 132125,
            ...
            },
            {
                ...
                "Jitter Raw": "0.009 ms",
                "Lost_Datagrams_ratio": "0%",
                "Lost_vs_Total_Datagrams": (0, 30),
                "Transfer": 660480,
                "Transfer Raw": "645 KBytes",
            },
        ],
        ("36062@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 132125,
                "Bitrate Raw": "1057 Kbits/sec",
                "Interval": (0.0, 1.0),
        ...
        ("52695@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 132125,
                "Bitrate Raw": "1057 Kbits/sec",
                "Interval": (0.0, 1.0),
    ...
    "CONNECTIONS": {
        ("127.0.0.1", "5016@127.0.0.1"): {
            "report": {
                ...
                "Jitter Raw": "0.000 ms",
                "Lost_Datagrams_ratio": "0%",
                "Lost_vs_Total_Datagrams": (0, 36),
                "Transfer": 792576,
                "Transfer Raw": "774 KBytes",
            }
        },
        ("35428@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 132125,
                "Bitrate Raw": "1057 Kbits/sec",
                "Interval": (0.0, 1.0),
        ...
        ("50221@127.0.0.1", "5016@127.0.0.1"): [
            {
                "Bitrate": 132125,
                "Bitrate Raw": "1057 Kbits/sec",
                "Interval": (0.0, 1.0),
...
COMMAND_RESULT_singlerun_server = {
    "CONNECTIONS": {
        ...
        ("38068@127.0.0.1", "5001@127.0.0.1"): [
            {
                "Bitrate": 3058334750,
...
COMMAND_KWARGS_singlerun_udp_server = {"options": "-s -p 5001 -f k -i 1.0"}
...
COMMAND_RESULT_singlerun_udp_server = {
    "CONNECTIONS": {
        ...
        ("44895@127.0.0.1", "5001@127.0.0.1"): [
            {
                "Bitrate": 132125,
                "Bitrate Raw": "1057 Kbits/sec",
                "Interval": (0.0, 1.0),
