...
class Socat(GenericUnixCommand):
    def __init__(
        ...
        self.current_ret["FEATURES"] = {}
        self.current_ret["FEATURES"]["defined"] = {}
        self.current_ret["FEATURES"]["undefined"] = []
...
COMMAND_KWARGS_basic_output = {"input_options": "SYSTEM:date", "output_options": "-"}
...
COMMAND_RESULT_both_types = {
    ...
    "INFO": [
        'W open("/dev/tty", O_NOCTTY, 0640): No such device or address',
...
COMMAND_KWARGS_version = {"options": "-V"}
