...
class Iperf(GenericUnixCommand):
    ...
    def _parse_connection_info(self, line):
        ...
        if regex_found(Iperf._re_iperf_record_udp_svr, line) or regex_found(
            Iperf._re_iperf_record, line
        ):
...
COMMAND_KWARGS_basic_client = {"options": "-c 10.1.1.1"}
...
COMMAND_KWARGS_basic_server = {"options": "-u"}
...
COMMAND_RESULT_bidirectional_udp_client = {
    "CONNECTIONS": {
        "local 192.168.0.10 port 56262 connected with 192.168.0.12 port 5016": [
            {
                "Transfer": 627712,
                "Bandwidth": 627750,
        ...
        "local 192.168.0.10 port 5016 connected with 192.168.0.12 port 47384": [
            {
...
COMMAND_KWARGS_bidirectional_udp_server = {"options": "-u -p 5016 -f k -i 1.0"}


COMMAND_RESULT_bidirectional_udp_server = {
    "CONNECTIONS": {
        "local 192.168.0.12 port 47384 connected with 192.168.0.10 port 5016": [
            {
                "Transfer": 627712,
                "Bandwidth": 627750,
                "Transfer Raw": "613 KBytes",
        ...
        "local 192.168.0.12 port 5016 connected with 192.168.0.10 port 56262": [
            {
                "Transfer Raw": "612 KBytes",
                "Jitter": "0.022 ms",
                "Transfer": 626688,
...
COMMAND_RESULT_multiple_connections = {
    "CONNECTIONS": {
        "local 192.168.0.102 port 57246 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57247 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57248 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57249 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57250 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57251 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57252 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57253 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.1 Mbits/sec",
                "Bandwidth": 1637500,
                "Interval": "0.0-10.8 sec",
        ...
        "local 192.168.0.102 port 57254 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57255 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57256 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.9 Mbits/sec",
                "Bandwidth": 1737500,
                "Interval": "0.0-10.7 sec",
        ...
        "local 192.168.0.102 port 57257 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "14.1 Mbits/sec",
                "Bandwidth": 1762500,
                "Interval": "0.0-10.8 sec",
        ...
        "local 192.168.0.102 port 57258 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57259 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.1 Mbits/sec",
                "Bandwidth": 1637500,
                "Interval": "0.0-10.6 sec",
        ...
        "local 192.168.0.102 port 57260 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.1 Mbits/sec",
                "Bandwidth": 1637500,
                "Interval": "0.0-10.6 sec",
        ...
        "local 192.168.0.102 port 57261 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.0 Mbits/sec",
                "Bandwidth": 1625000,
                "Interval": "0.0-10.6 sec",
        ...
        "local 192.168.0.102 port 57262 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57263 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.0 Mbits/sec",
                "Bandwidth": 1625000,
                "Interval": "0.0-10.7 sec",
        ...
        "local 192.168.0.102 port 57264 connected with 192.168.0.100 port 5001": [
            {
        ...
        "local 192.168.0.102 port 57265 connected with 192.168.0.100 port 5001": [
            {
                "Bandwidth Raw": "13.0 Mbits/sec",
                "Bandwidth": 1625000,
                "Interval": "0.0-10.7 sec",
