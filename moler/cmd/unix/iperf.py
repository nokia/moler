...
class Iperf(GenericUnixCommand):
    def __init__(self, connection, options, prompt=None, new_line_chars=None):
        super(Iperf, self).__init__(connection=connection, prompt=prompt, new_line_chars=new_line_chars)
    ...
    def _normalise_units(self, report, dictonary_to_update):
        for (index, item) in enumerate(report):
            if 'Bytes' in item or 'bits' in item:
                raw_bites = self._converter_helper.to_bytes(item)[0]
                new_column_title = self._list_of_connections[index] + " Raw"
                dictonary_to_update.update({new_column_title: raw_bites})
...
COMMAND_RESULT_basic_client = {
    'CONNECTIONS':
        {'local 192.168.0.102 port 49597 connected with 192.168.0.100 port 5001': [
            ...
            {'Bandwidth': '222 Mbits/sec', 'Bandwidth Raw': 232783872, 'Transfer': '26.5 MBytes',
             'Transfer Raw': 27787264, 'Interval': '2.0- 3.0 sec'},
            {'Bandwidth': '223 Mbits/sec', 'Bandwidth Raw': 233832448, 'Transfer': '26.6 MBytes',
             'Transfer Raw': 27892121, 'Interval': '3.0- 4.0 sec'},
            {'Bandwidth': '218 Mbits/sec', 'Bandwidth Raw': 228589568, 'Transfer': '26.0 MBytes',
             'Transfer Raw': 27262976, 'Interval': '4.0- 5.0 sec'},
            {'Bandwidth': '220 Mbits/sec', 'Bandwidth Raw': 230686720, 'Transfer': '26.2 MBytes',
             'Transfer Raw': 27472691, 'Interval': '5.0- 6.0 sec'},
            {'Bandwidth': '224 Mbits/sec', 'Bandwidth Raw': 234881024, 'Transfer': '26.8 MBytes',
             'Transfer Raw': 28101836, 'Interval': '6.0- 7.0 sec'},
            {'Bandwidth': '218 Mbits/sec', 'Bandwidth Raw': 228589568, 'Transfer': '26.0 MBytes',
             'Transfer Raw': 27262976, 'Interval': '7.0- 8.0 sec'},
            {'Bandwidth': '216 Mbits/sec', 'Bandwidth Raw': 226492416, 'Transfer': '25.8 MBytes',
             'Transfer Raw': 27053260, 'Interval': '8.0- 9.0 sec'},
            {'Bandwidth': '221 Mbits/sec', 'Bandwidth Raw': 231735296, 'Transfer': '26.4 MBytes',
             'Transfer Raw': 27682406, 'Interval': '9.0-10.0 sec'},
            {'Bandwidth': '222 Mbits/sec', 'Bandwidth Raw': 232783872, 'Transfer': '265 MBytes',
             'Transfer Raw': 277872640, 'Interval': '0.0-10.0 sec'}]},
    ...
    'CONNECTIONS': {
        'local 10.1.1.1 port 5001 connected with 10.6.2.5 port 32781': [{'Bandwidth': '9.84 Mbits/sec',
                                                                        ...
                                                                        {'Bandwidth': '8.87 Mbits/sec',
                                                                         'Bandwidth Raw': 9300869,
                                                                         'Datagrams': '(0.13%)',
                                                                         'Interval': '6.0- 7.0 sec',
                                                                         'Jitter': '1.803 ms',
                                                                         'Lost/Total': '1/ 755',
                                                                         'Transfer': '1.06 MBytes',
                                                                         'Transfer Raw': 1111490},
                                                                        {'Bandwidth': '10.0 Mbits/sec',
                                                                         'Bandwidth Raw': 10485760,
                                                                         'Datagrams': '(0%)',
                                                                        ...
                                                                        {'Bandwidth': '9.86 Mbits/sec',
                                                                         'Bandwidth Raw': 10338959,
                                                                         'Datagrams': '(0.11%)',
                                                                         'Interval': '0.0-10.0 sec',
                                                                         'Jitter': '2.618 ms',
                                                                         'Lost/Total': '9/ 8409',
                                                                         'Transfer': '11.8 MBytes',
                                                                         'Transfer Raw': 12373196}]},
...
COMMAND_RESULT_multiple_connections = {
    'CONNECTIONS': {
        ...
        'local 192.168.0.102 port 57264 connected with 192.168.0.100 port 5001': [{'Bandwidth': '12.3 Mbits/sec',
                                                                                   'Bandwidth Raw': 12897484,
                                                                                   'Interval': '0.0-10.7 sec',
                                                                                   'Transfer': '15.6 MBytes',
                                                                                   'Transfer Raw': 16357785}],
