...
class Chown(GenericUnixCommand):
    def __init__(self, connection, param, filename, options=None, prompt=None, new_line_chars=None):
        super(Chown, self).__init__(connection, prompt=prompt, new_line_chars=new_line_chars)
        self.param = param
