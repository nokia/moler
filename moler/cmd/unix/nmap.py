...
class Nmap(GenericUnixCommand):
    ...
    def __init__(self, connection, ip, is_ping=False, option=None, prompt=None, new_line_chars=None, runner=None):
        super(Nmap, self).__init__(connection=connection, prompt=prompt, new_line_chars=new_line_chars, runner=runner)
        self.option = option
        self.ip = ip
