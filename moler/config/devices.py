...
def define_device(name, device_class, initial_state, connection_desc, connection_hops):
    """Assign name to device specification."""
    named_devices[name] = (device_class, initial_state, connection_desc, connection_hops)
