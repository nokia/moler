...
class Scpi3(ProxyPc3):
    ...
    def _prepare_state_prompts_with_proxy_pc(self):
        ...
        state_prompts = {
            Scpi3.scpi:
                self._configurations[Scpi3.connection_hops][Scpi3.proxy_pc][Scpi3.scpi][
    ...
    def _prepare_state_prompts_without_proxy_pc(self):
        ...
        state_prompts = {
            Scpi3.scpi:
                self._configurations[Scpi3.connection_hops][Scpi3.unix_local][Scpi3.scpi][
                    "command_params"]["expected_prompt"],
        }
        return state_prompts
    ...
    def _prepare_state_hops_with_proxy_pc(self):
        ...
        state_hops = {
            Scpi3.not_connected: {
                Scpi3.scpi: Scpi3.unix_local,
                Scpi3.proxy_pc: Scpi3.unix_local,
                Scpi3.unix_local_root: Scpi3.unix_local,
            },
            Scpi3.scpi: {
                Scpi3.not_connected: Scpi3.proxy_pc,
                Scpi3.unix_local: Scpi3.proxy_pc,
                Scpi3.unix_local_root: Scpi3.proxy_pc
            },
            Scpi3.unix_local: {
                Scpi3.scpi: Scpi3.proxy_pc,
            },
            Scpi3.unix_local_root: {
                Scpi3.scpi: Scpi3.unix_local,
                Scpi3.not_connected: Scpi3.unix_local,
            },
            Scpi3.proxy_pc: {
                Scpi3.not_connected: Scpi3.unix_local,
            }
    ...
    def _get_packages_for_state(self, state, observer):
        ...
        """
        available = super(Scpi3, self)._get_packages_for_state(state, observer)

        if not available:
            if state == Scpi3.scpi:
                available = {Scpi3.cmds: ['moler.cmd.scpi.scpi'],
                             Scpi3.events: ['moler.events.unix', 'moler.events.scpi']}
            if available:
