...
class TableText:
    ...
    def parse(self, data):
        ...
        if not self.header_positions:
            ...
            for header_index in range(0, header_keys_number, 1):
                res, value_index = self.get_value_for_header(header_index,
                                                             split_values_positions, value_index)
    ...
    def get_value_for_header(self, current_header_position, values, start_value_index):
        ...
        return self.convert_data_to_type(data_value), start_value_index + value_index + 1
    ...
    def split_with_end_position(values, data):
        ...
        for i in range(1, len(values), 1):
            ...
            current_search = re.search(r'[\b\s]??' + re.escape(values[i]) + r'[\b\s]??', data[current_end:])
...
COMMAND_KWARGS = {"_header_regexps": ["UID", "PID", "PPID", "C", "STIME", "TTY", "CMD", "TIME"],
                  "_header_keys": ["UID1", "PID", "PPID", "C", "STIME", "TTY", "CMD"]}

COMMAND_RESULT = [
    {'UID1': 'avahi-a+', 'PID': 3597.5, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:45',
     'CMD': 'avahi-autoipd: [ens4] sleeping'},
    {'UID1': 'root', 'PID': 3598, 'PPID': 3597, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:00',
     'CMD': 'avahi-autoipd: [ens4] callout dispatcher'},
    {'UID1': 'root', 'PID': 3681, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:17',
     'CMD': '/sbin/dhclient6 -6 -cf /var/lib/dhcp6/dhclient6.ens3.conf -lf /var/lib/dhcp6/dhclient6.ens3.lease -pf'},
    {'UID1': 'root', 'PID': 3812, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:00',
     'CMD': '/usr/sbin/xinetd -stayalive -dontfork'},
    {'UID1': 'root', 'PID': 3814, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:00',
     'CMD': '/usr/sbin/vsftpd /etc/vsftpd.conf'},
    {'UID1': 'root', 'PID': 3826, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:02',
     'CMD': '/usr/sbin/sshd -D'},
    {'UID1': 'root', 'PID': 3835, 'PPID': 2, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:00', 'CMD': '[cifsiod]'},
    {'UID1': 'root', 'PID': 3867, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:18',
     'CMD': '/usr/sbin/cron -n'},
    {'UID1': 'root', 'PID': 3870, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': 'tty1', 'COL_8': '00:00:00',
     'CMD': '/sbin/agetty --noclear tty1 linux'},
    {'UID1': 'avahi-a+', 'PID': 4592, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:17:15',
     'CMD': 'avahi-autoipd: [ens3] sleeping'},
    {'UID1': 'root', 'PID': 45931, 'PPID': 92, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:00',
     'CMD': 'avahi-autoipd: [ens3] callout dispatcher'},
    {'UID1': 'root', 'PID': 4648, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?', 'COL_8': '00:00:00',
     'CMD': '/sbin/dhcpcd --netconfig -L -E -HHH -c /etc/sysconfig/network/scripts/dhcpcd-hook -t 0 -h FZM-FDD-086-'},
    {'UID1': 'root', 'PID': 5823, 'PPID': 2, 'C': 0, 'STIME': 'Mar09', 'TTY': '?', 'COL_8': '00:00:03',
     'CMD': '[kworker/u8:2]'},
    {'UID1': 'dr768nsk', 'PID': 5823, 'PPID': 2, 'C': 0, 'STIME': 'Mar09', 'TTY': '?', 'COL_8': '',
     'CMD': '[kworker/u8:2]'},
...
COMMAND_RESULT_V2 = [{'UID1': 'avahi-a+', 'PID': 3597, 'PPID': 1, 'C': 0, 'STIME': 2017, 'TTY': '?',
                      'TIME': '00:00:45', 'CMD': 'avahi-autoipd: [ens4] sleeping'}]

COMMAND_KWARGS_V2 = {"_header_regexps": ["UID", "PID", "PPID", "C", "STIME", "TTY", "CMD", "TIME"],
...
COMMAND_RESULT_V3 = [{'Name': 'MME-1', 's1': 'off', 's1u': '-', 's11': 'off', "s5": '-', "s5u": '-', "nas": 'off', "rrc": '-', "x2": '-', "m3": 'off', "x2u": '-', "lppa": 'off'},
                     {'Name': 'SGW-1', 's1': '-', 's1u': 'off', 's11': 'off', "s5": 'off', "s5u": 'off', "nas": '-', "rrc": '-', "x2": '-', "m3": '-', "x2u": '-', "lppa": '-'},
                     {'Name': 'PGW-1', 's1': '-', 's1u': '-', 's11': '-', "s5": 'off', "s5u": 'off', "nas": '-', "rrc": '-', "x2": '-', "m3": '-', "x2u": '-', "lppa": '-'}]


COMMAND_KWARGS_V3 = {"_header_regexps": ["", "s1", "s1u", "s11", "s5", "s5u", "nas", "rrc", "x2", "m3", "x2u", "lppa"],
                     "_header_keys": ["Name", "s1", "s1u", "s11", "s5", "s5u", "nas", "rrc", "x2", "m3", "x2u", "lppa"],
                     "_skip": '^(-+)|(=+)'}
...
COMMAND_RESULT_V4 = [{'Proto': 'unix', 'RefCnt': 2, 'Flags': '[ ]', 'Type': 'DGRAM', 'State': 'zsad', 'INode': 13962, 'Path': '/var/lib/dhcp6/dev/log'},
                     {'Proto': 'unix', 'RefCnt': 3, 'Flags': '', 'Type': 'STREAM', 'State': 'CONNECTED', 'INode': 14058, 'Path': '/var/lib/dhcp6/dev/log'},
                     {'Proto': 'unix', 'RefCnt': 3, 'Flags': '[ ]', 'Type': 'STREAM', 'State': 'CONNECTED', 'INode': 14007, 'Path': ''},
                     {'Proto': 'unix', 'RefCnt': '', 'Flags': '', 'Type': '', 'State': '', 'INode': '', 'Path': ''}]

COMMAND_KWARGS_V4 = {"_header_regexps": ["Proto", "RefCnt", "Flags", "Type", "State", "I-Node", "Path"],
